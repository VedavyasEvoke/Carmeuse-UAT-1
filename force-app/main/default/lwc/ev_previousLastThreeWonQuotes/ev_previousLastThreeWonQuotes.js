...
import getPreviousQuoteLineDetails from '@salesforce/apex/ev_PreviouslineItems.retrieveWonQuoteLines';
import { getRecord } from 'lightning/uiRecordApi';

const FIELDS = ['SBQQ__Quote__c.Customer_Region__c'];

export default class Ev_previousLastThreeWonQuotes extends LightningElement {
    @api recordId;
